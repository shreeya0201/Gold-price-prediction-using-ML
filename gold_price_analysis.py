...
ds_etf = 'Close'
date_format = '%Y-%m-%d'
df = pd.read_csv("data/data_inr.csv")
df = df[['Name', ds_gold]]
...
data = pd.read_csv("data/dataset2018.csv") 
data.head()
x_18 = data.iloc[:,0]
y_18 = data.iloc[:,1]
...
data2017 = pd.read_csv("data/dataset2017.csv") 
...
data2016 = pd.read_csv("data/dataset2016.csv") 
...
data2015 = pd.read_csv("data/dataset2015.csv")
...
data2014 = pd.read_csv("data/dataset2014.csv")
...
data2014 = pd.read_csv("data/dataset2013.csv")
x_14 = data2014.iloc[:,0]
y_14 = data2014.iloc[:,1]
new_14 = [dt.datetime.strptime(d,'%d-%m-%Y').date() for d in x_14]
plt.plot(new_14,y_14, '.r',color='g')
...
data2014 = pd.read_csv("data/datasetfull.csv")
x_14 = data2014.iloc[:,0]
y_14 = data2014.iloc[:,1]
new_14 = [dt.datetime.strptime(d,'%d-%m-%Y').date() for d in x_14]
plt.plot(new_14,y_14, '.r',color='g')
